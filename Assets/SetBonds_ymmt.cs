...
public class SetBonds : MonoBehaviour {
    ...
    public void CreateBonds()
    {
        ...
        Rigidbody rigid = AtomsList[0].GetComponent<Rigidbody>();
        FixedJoint joint;
    ...
    void CalcBond(GameObject obj1, GameObject obj2) {
            ...
            BOND_JUDGMENT > distance)   // 距離が定数値を下回っていれば
        {
            ...
            //Rigidbody rigid = ChemicalBond.GetComponent<Rigidbody>(); // Rigidbodyコンポーネントを追加
            ...
            FixedJoint joint = ChemicalBond.AddComponent<FixedJoint>();
